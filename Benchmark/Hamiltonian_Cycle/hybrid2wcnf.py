...
def h2xwcnf(grid, degree, num_hash, seed):
    homedir = "./"
    hardCNF, EO, softXOR, nv = read_hybrid(homedir + "/hybrid/cycle_reg_n" + str(grid) + "_d" + str(degree) + "_x" + str(num_hash) + "_" + str(seed) + ".hybrid")
    topid = nv
    ...
    with open(homedir + "/wcnf/cycle_reg_n" + str(grid) + "_d" + str(degree) + "_x" + str(num_hash) + "_" + str(seed) + ".wcnf", 'w') as f:
