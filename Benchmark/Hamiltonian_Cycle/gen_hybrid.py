...
def generate_hybrid(grid, degree, num_hash, seed):
    homedir = "./"
    ...
    with open(homedir + "/hybrid/cycle_reg_n" + str(grid) + "_d" + str(degree) + "_x" + str(num_hash) + "_" + str(seed) + ".hybrid", 'w') as f:
...
def main():
    ...
    for i in range(num):
        generate_hybrid(size, degree, hash, i)
